...
class AddFoundScreen extends ConsumerStatefulWidget {
  const AddFoundScreen({super.key});

  @override
  ConsumerState createState() => _AddFoundScreenState();
}

class _AddFoundScreenState extends ConsumerState<AddFoundScreen> {
  @override
