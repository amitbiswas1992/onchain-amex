...
class CardInfoTile extends StatelessWidget {
  ...
  const CardInfoTile({super.key, required this.title, required this.value});

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: AppValues.paddingSmall + 2),
      child: Row(
        children: [
          Expanded(
            child: Column(
          ...
          InkResponse(onTap: () {}, child: const Icon(Icons.copy)),
        ],
      ),
    );
  }
